    ...
    <section className="bg-gray-950 text-white py-24 px-6 text-center">
      <div className="max-w-5xl mx-auto mb-16">
        ...
        <p className="text-gray-300 text-lg leading-relaxed">
          ...
          <span className="text-red-400 font-semibold">الراء</span> نقدم لك أفضل
          أنواع البروتينات والمكملات الغذائية لتساعدك على تحقيق أهدافك
          الرياضية بأمان وفعالية.
        </p>
      </div>
      ...
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
        {[
          {
            icon: <FaDumbbell className="text-red text-4xl text-center mx-auto mb-4" />,
          ...
          >
            {item.icon}
            <h3 className="text-2xl font-semibold mb-3 text-red">
              {item.title}
            </h3>
