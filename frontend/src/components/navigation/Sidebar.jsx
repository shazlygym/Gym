    ...
    >
     ...
     <section className="space-y-4">
      ...
      <p className="font-medium text-gray-400">
        تعرف على من نحن وما الذي يجعلنا مميزين. نحن صالة رياضية قائمة على المجتمع،
        ملتزمون بتقديم تجارب لياقة شخصية لجميع المستويات في بيئة ترحيبية وداعمة.
      </p>
    </section>
      <section className="space-y-4">
      ...
      <h2 className="text-xl font-bold">معلومات التواصل</h2>
        <div className="flex flex-col items-start gap-2">
          ...
          >
            ...
            شارع جولستان السابع، پاسداران، طهران
          </Link>
          <Link
            to="tel:+982122542971"
            className="focus flex items-center gap-2 font-medium text-gray-400 transition-colors duration-300 hover:text-red"
      ...
      <section className="space-y-4">
      <h2 className="text-xl font-bold">تابعنا على</h2>
